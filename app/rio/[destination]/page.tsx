...
const destinationDetails: Record<string, any> = {
  copacabana: {
    ...
    passengers: "15+ passageiros frequentemente",
  ...
  "cristo-redentor": {
    ...
    passengers: "8+ passageiros frequentemente",
  ...
  ipanema: {
    ...
    passengers: "12+ passageiros frequentemente",
  ...
  galeao: {
    ...
    passengers: "1-4 passageiros por viagem",
  ...
  rodoviario: {
    ...
    passengers: "1-8 passageiros por viagem",
  ...
  "monte-verde": {
    ...
    passengers: "4-6 passageiros frequentemente",
    bestTime: "O ano todo",
  ...
  centro: {
    ...
    passengers: "6+ passageiros frequentemente",
